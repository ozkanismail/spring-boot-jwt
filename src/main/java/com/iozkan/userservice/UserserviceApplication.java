...
public class UserserviceApplication {
	...
	CommandLineRunner run(UserService userService){
		return args -> {
			...
			if(userService.getUser("ismailozkan")==null){
				...
				userService.saveUser(new User(null,"İsmail Özkan","ismailozkan","1234",new ArrayList<>()));
				...
				userService.addRoleToUser("ismailozkan","ROLE_USER");
				userService.addRoleToUser("ismailozkan","ROLE_MANAGER");
				userService.addRoleToUser("ismailozkan","ROLE_ADMIN");
				userService.addRoleToUser("ismailozkan","ROLE_SUPER_ADMIN");
